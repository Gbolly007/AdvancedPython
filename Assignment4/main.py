...
def num_param(text):
    ...
    return num_param(text[close_index + 1:]) + count + len(lines)  # + inside_n
...
def main():
    ...
    n1 += aarith
    nu1 += 1 if pplus != 0 else 0
    nu1 += 1 if mminus != 0 else 0
    nu1 += 1 if ddivide != 0 else 0
    nu1 += 1 if mmult != 0 else 0
    ...
    n1 += logic_n
    nu1 += 1 if eequal != 0 else 0
    nu1 += 1 if nnegate != 0 else 0
    nu1 += 1 if aand != 0 else 0
    nu1 += 1 if nnot != 0 else 0
    print("logic:", logic_n)
    aassign = num_assign(src_code_without_strings)
    n1 += aassign
    nu1 += 1 if aassign != 0 else 0
    ...
    n2 += arg_n
    nu2 += 1 if arg_n != 0 else 0
    print("args:", arg_n)
    print("N2:", n2)

    print("\n[program]")
    N = n1 + n2
    print('{}{}'.format("vocabulary:".ljust(10), str(nu1 + nu2)))
    print('{}{}'.format("length:".ljust(10), str(n1 + n2)))
    L = nu1 * math.log(nu1, 2) + nu2 * math.log(nu2, 2)
    print('{}{}'.format("calc_length:".ljust(10), str(L)))
    V = N * math.log(nu1 + nu2, 2)
    print('{}{}'.format("volume:".ljust(10), str(V)))
    D = (nu1 / 2) * (n2 / nu2)
    print('{}{}'.format("difficulty:".ljust(10), str(D)))
    E = D * V
    print('{}{}'.format("effort:".ljust(10), str(E)))
